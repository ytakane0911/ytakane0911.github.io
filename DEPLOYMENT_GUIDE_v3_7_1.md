# Deploying the audited v3.7.1 site to GitHub Pages
...
```bash
git branch backup-pre-v3.7.1-20260801
git push origin backup-pre-v3.7.1-20260801
git tag pre-v3.7.1-20260801
git push origin pre-v3.7.1-20260801
```
...
git diff --stat
git add -A
git commit -m "Deploy redesigned personal website v3.7.1"
...
```bash
git switch main
git reset --hard pre-v3.7.1-20260801
git push --force-with-lease origin main
```

A safer non-force alternative is to revert the v3.7.1 deployment commit from the GitHub commit page.
